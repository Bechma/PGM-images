...
// PRACTICA 6
	...
	Lista operator+(const string & suma) const;
	Lista &operator= (const Lista &referencia);
/////////////////////////////////////////////////////////////////
...
/**==3642== All heap blocks were freed -- no leaks are p==3642== All heap blocks were freed -- no leaks are possible
==3642== All heap blocks were freed -- no leaks are possible
ossible
...
* o una cadena vacia en caso contrario==3642== All heap blocks were freed -- no leaks are possible
